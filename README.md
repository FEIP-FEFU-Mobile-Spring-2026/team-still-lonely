...
Проект перенесён в новый репозиторий. Реализованы каталог (HW2), детали товара (HW3), API с оффлайн-режимом (HW4), корзина с оформлением заказа (HW5) и настроен статический анализ кода (HW6).Проект перенесён в новый репозиторий. Реализованы каталог (HW2), детали товара (HW3), API с оффлайн-режимом (HW4) и корзина с оформлением заказа (HW5).
